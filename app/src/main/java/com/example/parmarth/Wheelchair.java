...
public class Wheelchair extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new viadapter(Wheelchair.this, infolist);

        recyclerView.setAdapter(adapter);
        db = FirebaseFirestore.getInstance();
        db.collection("Job_Profile").whereEqualTo("Job_Type","WheelChair Bound")
